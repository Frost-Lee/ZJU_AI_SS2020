...
最后，rz-full 取得的性能表现说明了我们使用的训练方式（使用前 4 轮生成的数据训练模型）存在一定的问题。在 AlphaGo Zero 论文中，此处的对策是从最近 500,000 次自对弈中随机选取训练数据。我们的训练方式可能较为缺乏多样性，使 reversi-zero “沉浸在自己的世界”，而忘记黑白棋存在的更多可能性。
