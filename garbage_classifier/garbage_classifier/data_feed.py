...
def data_feed(path, input_size, sample_path=None, batch_size=4, validation_split=0.1):
    ...
    data_generator = keras.preprocessing.image.ImageDataGenerator(
        featurewise_center=sample_path is not None,
        featurewise_std_normalization=sample_path is not None,
        rotation_range=180,
